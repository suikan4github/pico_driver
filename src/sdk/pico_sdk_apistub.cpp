...
{
  assert(false &&
         "Error : The hardware_watchdog library is missing in the link phase.");
}
#if defined(_MSC_VER)  // weak binding in MSVC must be after definition
#if defined(_M_IX86)   // for x86
#pragma comment( \
    linker,      \
    "/alternatename:_watchdog_caused_reboot=__weak_watchdog_caused_reboot")
#elif defined(_M_AMD64)  // for AMD64
#pragma comment( \
    linker,      \
    "/alternatename:watchdog_caused_reboot=_weak_watchdog_caused_reboot")
#endif  // x86 or amd64
#endif  // _MSC_VER
// --------------------------------------------------
#if defined(__GNUC__) || defined(__clang__)  // Compiler detection
...
#if defined(_M_IX86)   // for x86
#pragma comment(linker, \
                "/alternatename:_watchdog_disable=__weak_watchdog_disable")
#elif defined(_M_AMD64)  // for AMD64
#pragma comment(linker, \
                "/alternatename:watchdog_disable=_weak_watchdog_disable")
#endif  // x86 or amd64
#endif  // _MSC_VER
// --------------------------------------------------
#if defined(__GNUC__) || defined(__clang__)  // Compiler detection
extern "C" void watchdog_enable(uint32_t delay_ms, bool pause_on_debug);
__attribute__((weak)) void watchdog_enable(uint32_t delay_ms,
                                           bool pause_on_debug)
#elif defined(_MSC_VER)  // Microsoft Visual C
...
#if defined(_M_IX86)   // for x86
#pragma comment(linker, \
                "/alternatename:_watchdog_enable=__weak_watchdog_enable")
#elif defined(_M_AMD64)  // for AMD64
...
#pragma comment( \
    linker,      \
    "/alternatename:_watchdog_enable_caused_reboot=__weak_watchdog_enable_caused_reboot")
#elif defined(_M_AMD64)  // for AMD64
#pragma comment( \
    linker,      \
    "/alternatename:watchdog_enable_caused_reboot=_weak_watchdog_enable_caused_reboot")
#endif  // x86 or amd64
#endif  // _MSC_VER
// --------------------------------------------------
#if defined(__GNUC__) || defined(__clang__)  // Compiler detection
...
#if defined(_M_IX86)   // for x86
#pragma comment( \
    linker, "/alternatename:_watchdog_get_count=__weak_watchdog_get_count")
#elif defined(_M_AMD64)  // for AMD64
#pragma comment(linker, \
                "/alternatename:watchdog_get_count=_weak_watchdog_get_count")
#endif  // x86 or amd64
#endif  // _MSC_VER
// --------------------------------------------------
#if defined(__GNUC__) || defined(__clang__)  // Compiler detection
...
#pragma comment( \
    linker,      \
    "/alternatename:_watchdog_get_time_remaining_ms=__weak_watchdog_get_time_remaining_ms")
#elif defined(_M_AMD64)  // for AMD64
#pragma comment( \
    linker,      \
    "/alternatename:watchdog_get_time_remaining_ms=_weak_watchdog_get_time_remaining_ms")
#endif  // x86 or amd64
#endif  // _MSC_VER
// --------------------------------------------------
#if defined(__GNUC__) || defined(__clang__)  // Compiler detection
extern "C" void watchdog_reboot(uint32_t pc, uint32_t sp, uint32_t delay_ms);
__attribute__((weak)) void watchdog_reboot(uint32_t pc, uint32_t sp,
                                           uint32_t delay_ms)
#elif defined(_MSC_VER)  // Microsoft Visual C
extern "C" void _weak_watchdog_reboot(uint32_t pc, uint32_t sp,
                                      uint32_t delay_ms)
#else                    // Other compilers are not supported
#error "Unknown compiler."
#endif  // Compiler detection
...
#if defined(_M_IX86)   // for x86
#pragma comment(linker, \
                "/alternatename:_watchdog_reboot=__weak_watchdog_reboot")
#elif defined(_M_AMD64)  // for AMD64
...
#if defined(_M_IX86)   // for x86
#pragma comment( \
    linker, "/alternatename:_watchdog_start_tick=__weak_watchdog_start_tick")
#elif defined(_M_AMD64)  // for AMD64
#pragma comment( \
    linker, "/alternatename:watchdog_start_tick=_weak_watchdog_start_tick")
#endif  // x86 or amd64
#endif  // _MSC_VER
// --------------------------------------------------
#if defined(__GNUC__) || defined(__clang__)  // Compiler detection
...
#if defined(_M_IX86)   // for x86
#pragma comment(linker, \
                "/alternatename:_watchdog_update=__weak_watchdog_update")
#elif defined(_M_AMD64)  // for AMD64
...
{
  assert(false &&
         "Error : The hardware_xosc library is missing in the link phase.");
}
#if defined(_MSC_VER)  // weak binding in MSVC must be after definition
#if defined(_M_IX86)   // for x86
