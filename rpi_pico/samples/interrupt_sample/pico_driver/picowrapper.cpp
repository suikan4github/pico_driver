...
bool pico_driver::PicoWrapper::gpio_get(uint gpio) { return ::gpio_get(gpio); }

void pico_driver::PicoWrapper::gpio_pull_up(uint gpio) { ::gpio_pull_up(gpio); }
...
int pico_driver::PicoWrapper::i2c_write_blocking(i2c_inst_t* i2c, uint8_t addr,
